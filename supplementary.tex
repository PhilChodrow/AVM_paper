...
\section{Mean-Field Approximation for $\alpha = 0$} \label{sec:SI_alpha_0}
  ...
  \begin{align*}
    \rho &= 2x_{01} \\ 
         &= 1 - x_{00} - x_{11} \\ 
         % &= 1 - 2\frac{q_0q_1}{c} - \frac{1}{2}(q_0(1+q_0 - q_1) + q_1(1+q_1 - q_0)) \\ 
         % &= 1 - 2\frac{q_0q_1}{c} - \frac{1}{2}( q_0^2 + q_1^2 - 2q_0q_1) \\ 
         % &= \frac{1}{2} - 2\frac{q_0q_1}{c} - \frac{(q_0 - q_1)^2}{2} \\ 
         % &= \frac{1}{2} - \frac{4q_0q_1 - c(q_0 - q_1)^2}{2c} \\ 
         &= 2q_0 q_1 \frac{c-1}{c}\;,
  \end{align*}
  as was to be shown. 
