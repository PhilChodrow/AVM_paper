...
\section{Adaptive Voter Models} \label{sec:AVMs}
	...
	\section{Analytical Methods} \label{sec:analytic}
		...
		\begin{figure}
			...
			Solid lines give the approximation to $\rho$ computed by numerically solving \Cref{eq:dynamics} and \Cref{eq:component_approx_super}. \pjm{Fix the Cref}} \label{fig:arch_tops}
		\end{figure}
		...
		\begin{figure}
			...
			Curves give theoretical predictions obtained by numerically solving \Cref{eq:dynamics} and \Cref{eq:component_approx_super} \pjm{Fix the Cref}. 
